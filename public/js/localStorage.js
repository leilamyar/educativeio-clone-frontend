...
const courseFromDb = fetch('../data/courses.mock.json')
  .then((data) => {console.log('type of data from server:', typeof data); 
  return data;})
  .catch(e => console.log('error fetching from server::', e));

console.log('in ls :::', courseFromDb)
